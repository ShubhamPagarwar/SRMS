...
public class CO4G
{
   ...
   public  CO4G()
   {
       ...
       AddingMarks123 fn = new AddingMarks123();
 ...
 class AddingMarks123 extends JFrame 
{  
   ...
   public static final int	HAND_CURSOR	= 12;
    ...
    public AddingMarks123()
   {  
      setTitle("CO4G External Marks Entry");
      setSize(1300,800);
	  setResizable(false);
     ...
     JLabel s2=new JLabel("Object Oriented Programming    ");
      ...
      SaveButton.addActionListener(new SaveDtls340());
     ...
     CloseButton.addActionListener(new  Closedt111());
...
private class Closedt111 extends JFrame implements ActionListener 
 { 
...
private class SaveDtls340 extends JFrame implements ActionListener 
 {
		public void actionPerformed(ActionEvent event)
		{
...
//TO INSERT INTO Marks DB
                                    s="insert into tco4g values("+en1+")";
                                   stmt.executeUpdate(s);

                                 CreateString="INSERT INTO ExCO4G VALUES("+en1+","+bs1+","+se1+","+comm1+","+app1+","+progc1+","+ele1+","+emat1+")";
			         stmt.executeUpdate(CreateString);
                                 ...
                                 stmt.executeUpdate(tru);    
                                                    ...
                                                    JOptionPane.showMessageDialog(SaveDtls340.this,"         Record of  Already Exist !","Duplicate !!!",JOptionPane.WARNING_MESSAGE);
                                                       System.err.println(e.getMessage());
                                                 }    
...
//TO CLEAR FIELDS
		if(freeflag == false)
		{
	   		...
	   		ELE.setText("");
                  ...
                  {
                        JOptionPane.showMessageDialog(SaveDtls340.this,"       Please Fill the information !","Empty !!!",JOptionPane.WARNING_MESSAGE);
                  }	
