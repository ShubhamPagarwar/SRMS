...
{  
   ...
   public static final int	HAND_CURSOR	= 12;
    ...
    public AddM3()
   {  
      setTitle("CO3G Internal Marks Entry");
      setSize(1300,800);
	  setResizable(false);
     ...
     WPI=new JLabel("Digital Technic Termwork  :   ");
      ...
      SaveButton.addActionListener(new Savem());
     ...
     CloseButton.addActionListener(new  Closem());
...
private class Closem extends JFrame implements ActionListener 
 { 
...
private class Savem extends JFrame implements ActionListener 
 {
		public void actionPerformed(ActionEvent event)
		{
...
//TO INSERT INTO Marks DB
                                 CreateString="INSERT INTO InCO3G VALUES("+en1+","+bs1+","+m1+","+m2+","+m3+","+m4+","+m5+","+m6+","+m7+","+m8+","+m9+")";
			         stmt.executeUpdate(CreateString);
                                 ...
                                 stmt.executeUpdate(tru);    
                                                    ...
                                                    JOptionPane.showMessageDialog(Savem.this,"         Record of Enrollnment no Already Exist !","Duplicate !!!",JOptionPane.WARNING_MESSAGE);
...
//TO CLEAR FIELDS
 ...
 t9.setText("");
                  ...
                  {
                        JOptionPane.showMessageDialog(Savem.this,"       Please Fill the information !","Empty !!!",JOptionPane.WARNING_MESSAGE);
                  }	
