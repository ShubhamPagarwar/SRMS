...
public class CO5EModify
{
   ...
   public  CO5EModify()
   {
       ...
       AddingMarks303 fn = new AddingMarks303();
 ...
 class AddingMarks303 extends JFrame 
{  
   ...
   public static final int	HAND_CURSOR	= 12;
    ...
    public AddingMarks303()
   {  
      setTitle("CO5E External Marks Correction");
      setSize(1300,800);
	  setResizable(false);
      ...
      label.add(ls);	
         ...
         JLabel s1=new JLabel("Operating System      ");
      s1.setFont(font);  
      panel3.add(s1);     
     ...
     JLabel s2=new JLabel("Software Engineering    ");
      s2.setFont(font);  
      panel4.add(s2);     
      ...
      JLabel s3=new JLabel("Computer Security     ");
      s3.setFont(font);  
      panel5.add(s3);     
      ...
      JLabel s4=new JLabel("JAVA Programming     ");
      s4.setFont(font);  
      panel6.add(s4);     
      ...
      JLabel s5=new JLabel("Advance Microprocessor     ");
      s5.setFont(font);  
      panel7.add(s5);     
      ...
      SaveButton.addActionListener(new SaveDtls3311());
      ...
      CloseButton.addActionListener(new  Closedt3121());
...
//Extract Student Record
                               ...
                               sql1="select exno1,brs,seatno,exops,exswe,excst,exjpr,examp from ExCO5E where exno1="+Integer.parseInt(re.getText());
                                ...
                                while(se2.next())
                              {
                                ...
                                comm2=se2.getInt("exops"); 
                                app2=se2.getInt("exswe");
                                progc2=se2.getInt("excst");
                                ele2=se2.getInt("exjpr");
                                emat2=se2.getInt("examp");
...
private class Closedt3121 extends JFrame implements ActionListener 
 { 
...
private class SaveDtls3311 extends JFrame implements ActionListener 
 {
		public void actionPerformed(ActionEvent event)
		{
...
//TO INSERT INTO Marks DB
                                ...
                                CreateString="Update ExCO5E set seatno="+se1+",exops="+comm1+",exswe="+app1+",excst="+progc1+",exjpr="+ele1+",examp="+emat1+"where exno1="+en1;
...
//TO CLEAR FIELDS
		if(freeflag == false)
		{
	   		...
	   		ELE.setText("");
                  ...
                  {
                        JOptionPane.showMessageDialog(SaveDtls3311.this,"       Please Fill the information !","Empty !!!",JOptionPane.WARNING_MESSAGE);
                  }	
