...
public class CO6EModify
{
   ...
   public  CO6EModify()
   {
       ...
       AddingMarks300 fn = new AddingMarks300();
 ...
 class AddingMarks300 extends JFrame 
{  
   ...
   public static final int	HAND_CURSOR	= 12;
    ...
    public AddingMarks300()
   {  
      setTitle("CO6E External Marks Correction");
      setSize(1300,800);
	  setResizable(false);
  ...
  JLabel s1=new JLabel("Management      ");
     ...
     JLabel s2=new JLabel("Software Testing    ");
      ...
      SaveButton.addActionListener(new SaveDtls3310());
      ...
      CloseButton.addActionListener(new  Closedt3120());
...
//Extract Student Record
                               ...
                               sql1="select exno1,brs,seatno,exman,exstg,exajp,exspg,exipr from ExCO6E where exno1="+Integer.parseInt(re.getText());
                                ...
                                while(se2.next())
                              {
                                ...
                                comm2=se2.getInt("exman"); 
                                app2=se2.getInt("exstg");
                                progc2=se2.getInt("exajp");
                                ele2=se2.getInt("exspg");
                                emat2=se2.getInt("exipr");
...
private class Closedt3120 extends JFrame implements ActionListener 
 { 
...
private class SaveDtls3310 extends JFrame implements ActionListener 
 {
		public void actionPerformed(ActionEvent event)
		{
...
//TO INSERT INTO Marks DB
                                ...
                                CreateString="Update ExCO6E set seatno="+se1+",exman="+comm1+",exstg="+app1+",exajp="+progc1+",exspg="+ele1+",exipr="+emat1+"where exno1="+en1;
...
//TO CLEAR FIELDS
		if(freeflag == false)
		{
	   		...
	   		ELE.setText("");
                  ...
                  {
                        JOptionPane.showMessageDialog(SaveDtls3310.this,"       Please Fill the information !","Empty !!!",JOptionPane.WARNING_MESSAGE);
                  }	
