...
public class CO2G
{
   ...
   public  CO2G()
   {
       ...
       AddingMarks1 fn = new AddingMarks1();
 ...
 class AddingMarks1 extends JFrame 
{  
   ...
   public static final int	HAND_CURSOR	= 12;
    ...
    public AddingMarks1()
   {  
      setTitle("CO2G External Marks Entry");
      setSize(1300,800);
	  setResizable(false);
     ...
     JLabel s2=new JLabel("Applid Science     ");
      ...
      SaveButton.addActionListener(new SaveDtls34());
     ...
     CloseButton.addActionListener(new  Closedt1());
...
private class Closedt1 extends JFrame implements ActionListener 
 { 
...
private class SaveDtls34 extends JFrame implements ActionListener 
 {
		public void actionPerformed(ActionEvent event)
		{
...
//TO INSERT INTO Marks DB
                                s="insert into tco2g values("+en1+")";
                                   stmt.executeUpdate(s);
                                 CreateString="INSERT INTO ExCO2G VALUES("+en1+","+bs1+","+se1+","+comm1+","+app1+","+progc1+","+ele1+","+emat1+")";
			         stmt.executeUpdate(CreateString);
                                 ...
                                 stmt.executeUpdate(tru);    
                                                    ...
                                                    JOptionPane.showMessageDialog(SaveDtls34.this,"         Record of  Already Exist !","Duplicate !!!",JOptionPane.WARNING_MESSAGE);
...
//TO CLEAR FIELDS
		if(freeflag == false)
		{
	   		...
	   		ELE.setText("");
                  ...
                  {
                        JOptionPane.showMessageDialog(SaveDtls34.this,"       Please Fill the information !","Empty !!!",JOptionPane.WARNING_MESSAGE);
                  }	
