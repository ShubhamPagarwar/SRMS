...
public class InCO1G
{
   ...
   public  InCO1G()
   {
       ...
       AddingMarkso fn = new AddingMarkso();
 ...
 class AddingMarkso extends JFrame 
{  
   ...
   public static final int	HAND_CURSOR	= 12;
    ...
    public AddingMarkso()
   {  
      setTitle("CO1G Internal Marks Entry");
      setSize(1300,800);
	  setResizable(false);
     ...
     WPI=new JLabel("Workshop Practice TermWork  :   ");
      ...
      JLabel lg2=new JLabel("Sessional:");
      lg2.setFont(font);
      panel12.add(lg2);
      t9=new JTextField(2);
      t9.setFont(font);
      ...
      SaveButton.addActionListener(new SaveDtls3540());
     ...
     CloseButton.addActionListener(new  Closedt5());
...
private class Closedt5 extends JFrame implements ActionListener 
 { 
...
private class SaveDtls3540 extends JFrame implements ActionListener 
 {
		public void actionPerformed(ActionEvent event)
		{
...
//TO INSERT INTO Marks DB
                                 CreateString="INSERT INTO InCO1G VALUES("+en1+","+bs1+","+m1+","+m2+","+m3+","+m4+","+m5+","+m6+","+m7+","+m8+","+m9+")";
			         stmt.executeUpdate(CreateString);
                                 ...
                                 stmt.executeUpdate(tru);   
                                                    ...
                                                    JOptionPane.showMessageDialog(SaveDtls3540.this,"         Record of Enrollnment no Already Exist !","Duplicate !!!",JOptionPane.WARNING_MESSAGE);
                            			 System.err.println(e.getMessage());
                                                 }    
...
//TO CLEAR FIELDS
		if(freeflag == false)
		{
	   		t1.setText("");
                  ...
                  {
                        JOptionPane.showMessageDialog(SaveDtls3540.this,"       Please Fill the information !","Empty !!!",JOptionPane.WARNING_MESSAGE);
                             System.err.println(e.getMessage());
