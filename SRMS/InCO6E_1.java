...
{  
   ...
   public static final int	HAND_CURSOR	= 12;
    ...
    public AddM6()
   {  
      setTitle("CO6E Internal Marks Entry");
      setSize(1300,800);
	  setResizable(false);
     ...
     WPI=new JLabel("System Programming  Termwork  :   ");
      ...
      SaveButton.addActionListener(new Saveg());
     ...
     CloseButton.addActionListener(new  Closeg());
...
private class Closeg extends JFrame implements ActionListener 
 { 
...
private class Saveg extends JFrame implements ActionListener 
 {
		public void actionPerformed(ActionEvent event)
		{
...
//TO INSERT INTO Marks DB
                                 CreateString="INSERT INTO InCO6E VALUES("+en1+","+bs1+","+m1+","+m2+","+m3+","+m4+","+m5+","+m6+","+m8+","+m9+")";
			         stmt.executeUpdate(CreateString);
                                 ...
                                 stmt.executeUpdate(tru);    
                                                    ...
                                                    JOptionPane.showMessageDialog(Saveg.this,"         Record of Enrollnment no Already Exist !","Duplicate !!!",JOptionPane.WARNING_MESSAGE);
...
//TO CLEAR FIELDS
 ...
 t9.setText("");
                  ...
                  {
                        JOptionPane.showMessageDialog(Saveg.this,"       Please Fill the information !","Empty !!!",JOptionPane.WARNING_MESSAGE);
                  }	
