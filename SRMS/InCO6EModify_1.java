...
public class InCO6EModify
{
 ...
 class AddModify6 extends JFrame 
{  
   ...
   public static final int	HAND_CURSOR	= 12;
    ...
    public AddModify6()
   {  
      setTitle("CO6E Internal Marks Correction");
      setSize(1300,800);
	  setResizable(false);
      ...
      label.add(ls);	
     ENG=new JLabel("Software Testing Oral:    ");
      ENG.setFont(font);  
      panel3.add(ENG);    
      t1=new JTextField(2);
      t1.setFont(font);
      ...
      PHY=new JLabel("Advanced Java Programming Practical :  ");
      PHY.setFont(font);  
      panel4.add(PHY);     
      t2=new JTextField(2);
      t2.setFont(font);
      ...
      CHE=new JLabel("Advanced Java Programming Termwork :    ");
      CHE.setFont(font);  
      panel5.add(CHE);     
       t3=new JTextField(2);
      t3.setFont(font);
      ...
      CMF=new JLabel("Entrepreneurship Development Termwork:     ");
      CMF.setFont(font);  
      panel6.add(CMF); 
       t4=new JTextField(2);
      t4.setFont(font);
      ...
      panel6.add(l4);
         ...
         JLabel ll=new JLabel("System Programming Oral:");
      ll.setFont(font);
      panel7.add(ll);
      t5=new JTextField(2);
      t5.setFont(font);
     ...
     WPI=new JLabel("System Programming  Termwork  :   ");
      WPI.setFont(font);  
      panel8.add(WPI);
        t6=new JTextField(2);
      t6.setFont(font);
      ...
      JLabel lg=new JLabel("Professional Practices-vI:");
      lg.setFont(font);
      panel11.add(lg);
      t8=new JTextField(2);
      t8.setFont(font);
      ...
      Save1Button.addActionListener(new Savel());
     ...
     CloseButton.addActionListener(new  Closel());
...
private class Closel extends JFrame implements ActionListener 
 { 
...
private class Savel extends JFrame implements ActionListener 
 {
		public void actionPerformed(ActionEvent event)
		{
...
//TO INSERT INTO Marks DB
				...
				stmt.executeUpdate(CreateString);
                                 ...
                                 stmt.executeUpdate(tru);    
                                                    ...
                                                    JOptionPane.showMessageDialog(Savel.this,"         Record of Enrollnment no Already Exist !","Duplicate !!!",JOptionPane.WARNING_MESSAGE);
...
//TO CLEAR FIELDS
 ...
 t9.setText("");
                  ...
                  {
                        JOptionPane.showMessageDialog(Savel.this,"       Please Fill the information !","Empty !!!",JOptionPane.WARNING_MESSAGE);
                  }	
