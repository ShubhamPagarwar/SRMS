...
public class InCO2GModify
{
 ...
 class AddModify extends JFrame 
{  
   ...
   public static final int	HAND_CURSOR	= 12;
    ...
    public AddModify()
   {  
      setTitle("CO2G Internal Marks Correction");
      setSize(1300,800);
	  setResizable(false);
      ...
      ENG=new JLabel("Communication Skill Oral :    ");
      ENG.setFont(font);  
      panel3.add(ENG);    
      t1=new JTextField(2);
      t1.setFont(font);
      ...
      PHY=new JLabel("Communication Skill Termwork :  ");
      PHY.setFont(font);  
      panel4.add(PHY);     
      t2=new JTextField(2);
      t2.setFont(font);
      ...
      CHE=new JLabel("Applid Science Practical :    ");
      CHE.setFont(font);  
      panel5.add(CHE);     
       t3=new JTextField(2);
      t3.setFont(font);
      ...
      CMF=new JLabel("Programming in 'C' Practical :     ");
      CMF.setFont(font);  
      panel6.add(CMF); 
       t4=new JTextField(2);
      t4.setFont(font);
      ...
      panel6.add(l4);
         ...
         JLabel ll=new JLabel("Programming in 'C' Termwork:");
      ll.setFont(font);
      panel7.add(ll);
      t5=new JTextField(2);
      t5.setFont(font);
     ...
     WPI=new JLabel("Basic Electronics Termwork  :   ");
      WPI.setFont(font);  
      panel8.add(WPI);
        t6=new JTextField(2);
      t6.setFont(font);
      ...
      JLabel lt=new JLabel("Development of Life Skills Oral:");
      lt.setFont(font);
      panel9.add(lt);
        t7=new JTextField(2);
      t7.setFont(font);
      ...
      JLabel lg=new JLabel("Web Page Designing:");
      lg.setFont(font);
      panel11.add(lg);
      t8=new JTextField(2);
      t8.setFont(font);
      ...
      Save1Button.addActionListener(new Save1Dtls3300());
...
//Extract Student Record
                               ...
                               sql1="select * from InCO2G where en="+Integer.parseInt(re.getText());
...
private class Close extends JFrame implements ActionListener 
 { 
...
private class Save1Dtls3300 extends JFrame implements ActionListener 
 {
		public void actionPerformed(ActionEvent event)
		{
...
//TO INSERT INTO Marks DB
                                ...
                                CreateString="Update InCO2G set cmo="+m1+",cmt="+m2+",apr="+m3+",progc="+m4+",progctw="+m5+",elect="+m6+",dlso="+m7+",wpd="+m8+",sw="+m9+" where en="+en1;
				...
				stmt.executeUpdate(CreateString);
                                 ...
                                 stmt.executeUpdate(tru);    
                                                    ...
                                                    JOptionPane.showMessageDialog(Save1Dtls3300.this,"         Record of Enrollnment no Already Exist !","Duplicate !!!",JOptionPane.WARNING_MESSAGE);
...
//TO CLEAR FIELDS
 ...
 t9.setText("");
                  ...
                  {
                        JOptionPane.showMessageDialog(Save1Dtls3300.this,"       Please Fill the information !","Empty !!!",JOptionPane.WARNING_MESSAGE);
                  }	
