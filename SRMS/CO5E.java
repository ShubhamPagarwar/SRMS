...
public class CO5E
{
   ...
   public  CO5E()
   {
       ...
       AddingMarks126 fn = new AddingMarks126();
 ...
 class AddingMarks126 extends JFrame 
{  
   ...
   public static final int	HAND_CURSOR	= 12;
    ...
    public AddingMarks126()
   {  
      setTitle("CO5E External Marks Entry");
      setSize(1300,800);
	  setResizable(false);
     ...
     JLabel s2=new JLabel("Software Engineering    ");
      ...
      SaveButton.addActionListener(new SaveDtls344());
     ...
     CloseButton.addActionListener(new  Closedt114());
...
private class Closedt114 extends JFrame implements ActionListener 
 { 
...
private class SaveDtls344 extends JFrame implements ActionListener 
 {
		public void actionPerformed(ActionEvent event)
		{
...
//TO INSERT INTO Marks DB
                                   s="insert into tco5e values("+en1+")";
                                   stmt.executeUpdate(s);

                                 CreateString="INSERT INTO ExCO5E VALUES("+en1+","+bs1+","+se1+","+comm1+","+app1+","+progc1+","+ele1+","+emat1+")";
			         stmt.executeUpdate(CreateString);
                                 ...
                                 stmt.executeUpdate(tru);    
                                                    ...
                                                    JOptionPane.showMessageDialog(SaveDtls344.this,"         Record of  Already Exist !","Duplicate !!!",JOptionPane.WARNING_MESSAGE);
...
//TO CLEAR FIELDS
		if(freeflag == false)
		{
	   		...
	   		ELE.setText("");
                  ...
                  {
                        JOptionPane.showMessageDialog(SaveDtls344.this,"       Please Fill the information !","Empty !!!",JOptionPane.WARNING_MESSAGE);
                  }	
