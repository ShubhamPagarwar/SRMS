...
{  
   ...
   public static final int	HAND_CURSOR	= 12;
    ...
    public AddM()
   {  
      setTitle("CO2G Internal Marks Entry");
      setSize(1300,800);
	  setResizable(false);
...
private class Save extends JFrame implements ActionListener 
 {
		public void actionPerformed(ActionEvent event)
		{
...
//TO INSERT INTO Marks DB
                                 CreateString="INSERT INTO InCO2G VALUES("+en1+","+bs1+","+m1+","+m2+","+m3+","+m4+","+m5+","+m6+","+m7+","+m8+","+m9+")";
			         stmt.executeUpdate(CreateString);
                                 ...
                                 stmt.executeUpdate(tru);    
                                                    ...
                                                    JOptionPane.showMessageDialog(Save.this,"         Record of Enrollnment no Already Exist !","Duplicate !!!",JOptionPane.WARNING_MESSAGE);
...
//TO CLEAR FIELDS
 ...
 t9.setText("");
                  ...
                  {
                        JOptionPane.showMessageDialog(Save.this,"       Please Fill the information !","Empty !!!",JOptionPane.WARNING_MESSAGE);
                  }	
