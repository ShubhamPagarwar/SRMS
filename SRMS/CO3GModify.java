...
public class CO3GModify
{
   ...
   public  CO3GModify()
   {
       ...
       AddingMarks301 fn = new AddingMarks301();
 ...
 class AddingMarks301 extends JFrame 
{  
   ...
   public static final int	HAND_CURSOR	= 12;
    ...
    public AddingMarks301()
   {  
      setTitle("CO3G External Marks Correction");
      setSize(1300,800);
	  setResizable(false);
     ...
     JLabel s2=new JLabel("Digital Technic     ");
      ...
      SaveButton.addActionListener(new SaveDtls3312());
      ...
      CloseButton.addActionListener(new  Closedt312());
...
//Extract Student Record
                               ...
                               sql1="select exeno1,brs,seatno,exdst,exdte,exrdbms,exapmath,exelectrical from ExCO3G where exeno1="+Integer.parseInt(re.getText());
                                ...
                                while(se2.next())
                              {
                                ...
                                comm2=se2.getInt("exdst"); 
                                app2=se2.getInt("exdte");
                                progc2=se2.getInt("exrdbms");
                                ele2=se2.getInt("exapmath");
                                emat2=se2.getInt("exelectrical");
...
private class Closedt312 extends JFrame implements ActionListener 
 { 
...
private class SaveDtls3312 extends JFrame implements ActionListener 
 {
		public void actionPerformed(ActionEvent event)
		{
...
//TO INSERT INTO Marks DB
                                ...
                                CreateString="Update ExCO3G set seatno="+se1+",exdst="+comm1+",exdte="+app1+",exrdbms="+progc1+",exapmath="+ele1+",exelectrical="+emat1+"where exeno1="+en1;
				...
				stmt.executeUpdate(CreateString);
                                 ...
                                 stmt.executeUpdate(tru);    
                                                ...
                                                //     JOptionPane.showMessageDialog(SaveDtls3312.this,"         Record of Enrollnment no Already Exist !","Duplicate !!!",JOptionPane.WARNING_MESSAGE);
...
//TO CLEAR FIELDS
		if(freeflag == false)
		{
	   		...
	   		ELE.setText("");
                  ...
                  {
                        JOptionPane.showMessageDialog(SaveDtls3312.this,"       Please Fill the information !","Empty !!!",JOptionPane.WARNING_MESSAGE);
                  }	
